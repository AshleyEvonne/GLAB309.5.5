...
public class RequestParamController {
    ...
    public String handler(@RequestParam String firstName, @RequestParam String lastName){
        return "URL parameter - <br>" + "firstName =" + firstName + " <br>" + "lastName= " + lastName;
    }
    ...
    /* The required=false attribute of @RequestParam annotation is used to make a method parameter as Optional i.e.
    it binds a null value to a method parameter if the request parameter is not present.  */
    @RequestMapping("/request5")
    @ResponseBody
    public String handler(@RequestParam("firstName")String firstName,
                          @RequestParam(name = "middleName", required = false)
                          String middleName, @RequestParam("lastName")String lastName)
    {
